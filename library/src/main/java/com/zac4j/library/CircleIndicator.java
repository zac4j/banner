...
public class CircleIndicator extends View implements Indicator {
  ...
  public CircleIndicator(Context context, AttributeSet attrs, int defStyle) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(attrs, R.styleable.CirclePagerIndicator, defStyle, 0);

    mCentered = a.getBoolean(R.styleable.CirclePagerIndicator_centered, defaultCentered);
    mOrientation =
        a.getInt(R.styleable.CirclePagerIndicator_android_orientation, defaultOrientation);
    mPaintPageFill.setStyle(Style.FILL);
    mPaintPageFill.setColor(
        a.getColor(R.styleable.CirclePagerIndicator_pageColor, defaultPageColor));
    mPaintStroke.setStyle(Style.STROKE);
    mPaintStroke.setColor(
        a.getColor(R.styleable.CirclePagerIndicator_strokeColor, defaultStrokeColor));
    mPaintStroke.setStrokeWidth(
        a.getDimension(R.styleable.CirclePagerIndicator_strokeWidth, defaultStrokeWidth));
